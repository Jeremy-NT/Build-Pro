...
export const Home: React.FC = () => {
  ...
  const [simulatedInquiryStatus, setSimulatedInquiryStatus] = useState<
    "new" | "read" | "responded"
  >("new");
  ...
  const simulatorFeatures = {
    agent: [
      {
        title: "Inquiry Inbox",
        desc: "Instantly receive inquiries in your dashboard styled with real-time status badges.",
      },
      {
        title: "Dynamic Conversion",
        desc: "Convert warm inquiries directly into client records with 1-click pre-fills.",
      },
      {
        title: "Reminders & Logs",
        desc: "Set smart notifications with overdue red alerts and timeline logs.",
      },
    ],
    client: [
      {
        title: "Secure Client Portal",
        desc: "Authentication-backed page keeping inquiries and replies strictly aligned.",
      },
      {
        title: "Inquiry Tracking",
        desc: "Track your pending inquiry responses with real-time progress status.",
      },
      {
        title: "Agent Live Responses",
        desc: "Instantly view conversations with assigned brokers dynamically.",
      },
    ],
  };
    ...
    <div className="bg-slate-50 min-h-screen font-sans">
      ...
      <div className="relative overflow-hidden bg-slate-900 text-white pt-20 pb-32 px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10 mb-12">
          ...
          <p className="mt-6 text-sm sm:text-base md:text-lg text-slate-300 max-w-2xl mx-auto leading-relaxed">
            Unify high-intent public house hunting with high-velocity agent
            workspace tools. Publish luxury listings, register active CRM
            profiles, and track client inquiries securely.
          </p>
          ...
          <div className="mt-8 flex flex-wrap gap-4 justify-center items-center">
            ...
            {/* 
              ...
              - loading: show placeholder (auth not yet verified)
              - no session: show Sign In + Create Account
              - session: show Go to Console
            */}
            {loading ? (
              // Show placeholder while auth is being verified
              <>
      ...
      <div className="relative -mt-8 z-30 max-w-5xl mx-auto px-4">
        <div className="bg-white rounded-2xl shadow-xl border border-slate-100 p-6 sm:px-10 grid grid-cols-2 lg:grid-cols-4 gap-6 text-center divide-y lg:divide-y-0 lg:divide-x divide-slate-100">
          <div className="pt-4 lg:pt-0">
            <span className="block text-2xl sm:text-3xl font-black text-slate-900 tracking-tight font-sans">
              150+
            </span>
            <span className="text-[10px] sm:text-xs text-slate-400 font-mono tracking-widest uppercase font-semibold">
              Listed Properties
            </span>
          </div>
          <div className="pt-4 lg:pt-0">
            <span className="block text-2xl sm:text-3xl font-black text-blue-600 tracking-tight font-sans">
              99.8%
            </span>
            <span className="text-[10px] sm:text-xs text-slate-400 font-mono tracking-widest uppercase font-semibold">
              CRM Delivery Rate
          ...
          <div className="pt-4 lg:pt-0">
            <span className="block text-2xl sm:text-3xl font-black text-emerald-600 tracking-tight font-sans">
              Under 1h
            </span>
            <span className="text-[10px] sm:text-xs text-slate-400 font-mono tracking-widest uppercase font-semibold">
              Response Window
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-12">
          ...
          <p className="text-xs md:text-sm text-slate-500 max-w-lg mx-auto mt-3">
            BuildProConnect is a dual-sided engine. Toggle below to simulate how
            agents and clients engage back and forth.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-white rounded-3xl p-6 sm:p-10 border border-slate-100 shadow-sm">
          ...
          <div className="lg:col-span-7 bg-slate-50 border border-slate-100 rounded-2xl p-4 sm:p-6 shadow-inner relative overflow-hidden self-stretch flex flex-col justify-between min-h-[360px]">
            <div className="flex items-center justify-between pb-3 border-b border-slate-200/80">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-[10px] text-slate-400 font-mono ml-1.5 uppercase font-semibold">
                  {activeSimTab === "agent"
                    ? "Agent Console Simulation // Live State"
                    : "Secure Portal Simulation // Client-View"}
                </span>
              </div>
              <span className="text-[10px] bg-slate-200/85 px-2 py-0.5 rounded text-slate-650 font-mono font-bold">
                200 OK
              </span>
            </div>
                ...
                <div className="space-y-3">
                  <div className="bg-white p-3.5 rounded-xl border border-slate-200/85 shadow-sm space-y-2">
                    ...
                    <p className="text-[10px] text-slate-500 font-mono">
                      From: pokentifafa@gmail.com
                    </p>
                    <p className="text-xs text-slate-755 italic">
                      "Is there structural space for a secondary kitchen annex?"
                    </p>
                  ...
                  <div className="bg-white p-3.5 rounded-xl border border-slate-200/85 shadow-sm">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[9px] font-bold bg-amber-100 text-amber-805 px-1.5 py-0.5 rounded">
                        Lead
                      </span>
                    </div>
                    <div className="mt-2 text-xs flex justify-between items-center text-slate-600 font-sans">
                      ...
                      <button
                        type="button"
                        className="bg-blue-600 text-white px-2 py-1 rounded text-[10px] font-bold hover:bg-blue-750"
                      >
                        Pre-fill Form
                      </button>
                    </div>
                ...
                <div className="space-y-3">
                  <div className="bg-slate-900 text-white p-4 rounded-xl space-y-2 shadow-md">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[9px] bg-blue-500/25 border border-blue-500/35 text-blue-400 px-2 py-0.5 rounded font-bold uppercase">
                        Active
                      </span>
                    </div>
                    <h5 className="text-xs font-bold font-sans">
                      Waterfront Townhouse, East Legon
                    </h5>
                    <p className="text-[11px] text-slate-300">
                      Message sent: "What are the common utilities service
                      rates?"
                    </p>
                    <div className="bg-slate-800/80 p-2.5 rounded border border-slate-700 text-[10.5px] text-slate-200 space-y-1">
                      ...
                      <p className="italic">
                        "Hi! Standard rates are GH₵450/month which includes
                        strict water and power backup systems maintenance."
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-slate-200/50 p-2 text-center rounded text-[10px] text-slate-500 font-medium">
              💡 Interactive simulator. Click the buttons inside the mockup
              window to experience live reactive CRM states.
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-550 text-xs sm:text-sm max-w-md mx-auto mt-2 leading-relaxed font-sans">
              BuildProConnect provides full-cycle synchronization. Our tools
              guard transactions and timelines perfectly.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-slate-50 p-6 rounded-2xl  relative overflow-hidden group hover:bg-blue-100 transition">
              ...
              <h3 className="text-sm font-extrabold text-slate-900 font-sans mb-2">
                Live Agent Reporting
              </h3>
              <p className="text-slate-500 text-xs font-sans leading-relaxed">
                Analyze property breakdowns, check interactive
                inquiries-per-week bar layouts, and see pipeline stages compiled
                automatically.
              </p>
            </div>
            ...
            <div className="bg-slate-50 p-6 rounded-2xl  relative overflow-hidden group hover:bg-blue-100 transition">
              ...
              <h3 className="text-sm font-extrabold text-slate-905 font-sans mb-2">
                Synchronized Overdue Alerts
              </h3>
              <p className="text-slate-500 text-xs font-sans leading-relaxed">
                Stay aligned on promises. Outstanding customer follow-up alerts
                are instantly marked in red during pending countdown stages.
              </p>
            </div>
            ...
            <div className="bg-slate-50 p-6 rounded-2xl  relative overflow-hidden group hover:bg-blue-100 transition">
              ...
              <h3 className="text-sm font-extrabold text-slate-900 font-sans mb-2">
                Pre-Filled Conversions
              </h3>
              <p className="text-slate-500 text-xs font-sans leading-relaxed">
                Instantly turn digital interactions and inbound queries into
                active customer CRM directory logs with auto-populated profile
                structures.
              </p>
            </div>
          </div>
      ...
      <div className="bg-slate-900 text-white py-20 px-4 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          <div className="text-center mb-12">
            <span className="text-[10px] text-blue-400 font-mono uppercase tracking-widest font-extrabold">
              Broker Reviews
            </span>
            <h2 className="text-2xl sm:text-3xl font-black text-white mt-2 font-sans">
              Endorsed by Top Performing Agencies
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-slate-800/60 p-6 rounded-2xl border border-slate-700/60 shadow-lg relative">
              ...
              <p className="text-xs sm:text-sm text-slate-300 italic leading-relaxed mb-6 font-sans">
                "The 1-click Convert to Client automation changed our team speed
                from hours to seconds. Our customers love tracking updates
                directly via their dedicated client portal."
              </p>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-500">
                    Managing Lead, Ablode Estate Group
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-800/60 p-6 rounded-2xl border border-slate-700/60 shadow-lg relative">
              ...
              <p className="text-xs sm:text-sm text-slate-300 italic leading-relaxed mb-6 font-sans">
                "The UI is exceptionally organized. Having properties synced
                inside Supabase RLS policies guarantees our confidential
                enterprise data remains isolated."
              </p>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-500">
                    Senior Broker, Vested Capital Properties
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-500 text-xs sm:text-sm mt-2">
            Have questions about BuildProConnect features? Find our system
            architecture and utility details below.
          </p>
        </div>
        ...
        <div className="space-y-3">
          {[
            ...
            return (
              <div
                key={index}
                className="bg-white border border-slate-200/85 rounded-xl overflow-hidden transition"
              >
                <button
                  type="button"
        ...
        <div className="bg-slate-900 rounded-3xl p-8 sm:p-12 text-center text-white relative overflow-hidden border border-slate-800 shadow-xl">
          ...
          <div className="relative z-10 space-y-6">
            <h2 className="text-2xl sm:text-4xl font-extrabold tracking-tight font-sans">
              Ready to Align Your Real Estate Business?
            </h2>
            <p className="text-slate-300 text-xs sm:text-sm max-w-xl mx-auto leading-relaxed">
              Equip your brand, manage active leads efficiently, and deliver a
              clean digital transaction journey for properties with ease. Setup
